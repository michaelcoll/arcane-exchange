...
/// Routes pushed onto whichever `NavigationStack` shows a card list. Both carry the whole
/// card: the list already holds it, so the detail and owners screens open without another
/// round-trip.
