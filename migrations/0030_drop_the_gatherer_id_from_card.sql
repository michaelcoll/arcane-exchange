-- ADR-0017 / #425 : les clients affichent les images stockées par la plateforme. L'identifiant
-- d'image Gatherer, avec lequel ils construisaient l'URL, n'a plus d'usage.
-- `mv_card_prices` l'expose : elle est recréée à l'identique, sans la colonne.
DROP MATERIALIZED VIEW mv_card_prices;

ALTER TABLE card
    DROP COLUMN the_gatherer_id;
